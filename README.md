...
<body>
    <header id="inicio">
        <nav>
            <a href="#link1" target="_self" >topologia de redes de computadores</a>
            <a href="#link2" target="_self">ponto_a_ponto</a>
            <a href="#link3" target="_self">barramento</a>
            <a href="#link4" target="_self">topologia em anel</a>
            <a href="#link5" target="_self">topologia em estrela</a>
            <a href="#link6" target="_self">malha</a>
            <a href="#link7" target="_self">hibrida</a>
        </nav>
    </header>
    <h1 id="link1">topologia de redes de computadores</h1>
    <p>
        Existem dois tipos de topologias, física e lógica
    </p>
    <p>
        A topologia física representa a disposição física dos componentes da rede de computadores e seus meios de
    ...
    <img src="barramento.png" alt="barramento">
    <p>
        <mark>
    ...
    <p>
        ...
        e quanto mais saltos forem necessários, maior será o custo total da comunicação.
    </p>
    <h2>árvore</h2>
    <p>
    ...
    <img src="hibrido.png" alt="topologia hibrida">
    <p>
